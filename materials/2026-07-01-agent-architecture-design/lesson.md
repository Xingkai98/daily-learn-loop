...
**Survey 论文：**
- **AI Agent Systems: Architectures, Applications, and Evaluation** (Xu, arXiv 2601.01743, Jan 2026) — 当前最全面的 AI Agent 架构综述，覆盖 reasoning/planning/tools/orchestration 的统一分类法。[https://arxiv.org/abs/2601.01743]
- **Architectural Design Decisions in AI Agent Harnesses** (Hu, arXiv 2604.18071, Apr 2026) — 实证研究 70 个开源 Agent 项目，提炼 5 种架构模式。[https://arxiv.org/abs/2604.18071]
- **Agentic Design Patterns: A System-Theoretic Framework** (Dao et al., arXiv 2601.19752, Jan 2026) — 12 种设计模式的系统论分类。[https://arxiv.org/abs/2601.19752]
